package Vista_listado_listas_compra;
...
public class Vista_Listado_Listas_Compra extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Vista_Listado_Listas_Compra frame = new Vista_Listado_Listas_Compra();
	 ...
	 * Create the frame.
	 */
	public Vista_Listado_Listas_Compra() {
